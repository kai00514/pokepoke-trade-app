                      ...
                      <div className="grid grid-cols-3 gap-4">
                        {row.cards && row.cards.length > 0 ? (
                          row.cards.map((cardRef: any, cardIndex: number) => {
                            ...
                            return (
                              <div key={cardIndex} className="flex flex-col items-center min-w-0">
                                <div className="aspect-[5/7] relative rounded-md border-2 border-gray-200 overflow-hidden bg-gray-100 w-full shadow-md hover:shadow-lg transition-shadow">
                                  {card ? (
                                    <Image
                                      src={getCardImageUrl(card) || "/placeholder.svg"}
                                      alt={card.name}
                                ...
                                <div className="mt-1 text-[8px] text-gray-700 text-center truncate w-full leading-tight font-medium">
                      ...
                      {row.valueType === "text" ? (
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 xl:grid-cols-12 gap-2">
                          {row.cardValues.map((cardValue: any, cardIndex: number) => {
                            ...
                            return (
                              <div key={cardIndex} className="flex flex-col items-center space-y-1 min-w-0">
                                <div className="aspect-[5/7] relative rounded-md border-2 border-gray-200 overflow-hidden bg-gray-100 w-full shadow-md hover:shadow-lg transition-shadow">
                                  {card ? (
                                    <Image
                                      src={getCardImageUrl(card) || "/placeholder.svg"}
                                ...
                                <p className="text-[8px] font-medium text-gray-900 text-center line-clamp-2 w-full leading-tight">
