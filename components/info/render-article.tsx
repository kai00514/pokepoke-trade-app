                          ...
                          row.cards.map((cardRef: any, cardIndex: number) => {
                            ...
                            return (
                              <div key={cardIndex} className="flex flex-col items-center">
                                <div className="aspect-[5/7] relative rounded-md border-2 border-gray-200 overflow-hidden bg-gray-100 w-[45px] shadow-md hover:shadow-lg transition-shadow">
                                  {card ? (
                                    <Image
                                      src={getCardImageUrl(card) || "/placeholder.svg"}
                                      alt={card.name}
                                ...
                                <div className="mt-1 text-[8px] text-gray-700 text-center truncate w-[45px] leading-tight font-medium">
                          ...
                          {row.cardValues.map((cardValue: any, cardIndex: number) => {
                            ...
                            return (
                              <div key={cardIndex} className="flex flex-col items-center space-y-1">
                                ...
                                <p className="text-[8px] font-medium text-gray-900 text-center line-clamp-2 w-[45px] leading-tight">
